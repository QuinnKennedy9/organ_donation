...
(function() {
	...
	function loadWhy(){
    	const url = '../organ_donation_copy2/admin/phpscripts/connect.php?why=true';
    	fetch(url)
    	.then((resp) => resp.json())
	...
	function loadHow(){
		const url = '../organ_donation_copy2/admin/phpscripts/connect.php?how=true';
		fetch(url)
		.then((resp) => resp.json())
    ...
    function loadStories(){
        const url = '../organ_donation_copy2/admin/phpscripts/connect.php?story=true';
        fetch(url)
        .then((resp) => resp.json())
    ...
    function loadMyths(){
        const url = '../organ_donation_copy2/admin/phpscripts/connect.php?myths=true';
        fetch(url)
        .then((resp) => resp.json())
    ...
    function loadOrgans(){
        const url = '../organ_donation_copy2/admin/phpscripts/connect.php?organs=true';
        fetch(url)
        .then((resp) => resp.json())
    ...
    function loadSpecificOrgan(id){
        const url = '../organ_donation_copy2/admin/phpscripts/connect.php?organid='+id;
        fetch(url)
        .then((resp) => resp.json())
    ...
    function loadVideo(){
        const url ='../organ_donation_copy2/admin/phpscripts/connect.php?video=true';
        fetch(url)
        .then((resp) => resp.json())
